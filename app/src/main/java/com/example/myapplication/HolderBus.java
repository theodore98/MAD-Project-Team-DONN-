...
public class HolderBus extends FirebaseRecyclerAdapter<Business,HolderBus.viewholder> {
    ...
    protected void onBindViewHolder(@NonNull final viewholder holder, final int position, @NonNull final Business business) {
        ...
        holder.owner.setText("Owner: "+business.getOwner());
        holder.mobileNo.setText("Mobile No: " + business.getMobileNo());
        holder.email.setText("Email: "+business.getEmail());
        holder.accountNo.setText("Account No: "+business.getAccountNumber());
        holder.bank.setText("Bank: "+business.getBank());
        holder.name.setText("Name:  "+business.getName());
        holder.address.setText("Address:  "+business.getAddress());
